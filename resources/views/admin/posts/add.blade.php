...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('posts.store') }}" method="post" class="p-1" enctype="multipart/form-data">
            @csrf
            <div class="row p-2">
                ...
                <div class="form-group col-5">
                    ...
                    <select name="tags_id[]" id="tags_id" class="h-25 select2 select2-multiple" data-toggle="select2"
                        ...
                        @foreach ($tags as $item)
                            <option value="{{ $item->id }}">{{ $item->name }}<span class="p-2" width="50px"
                                    height="50px"></span></option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-2 p-2">
                    <div class="form-check mt-3">
                        ...
                        <label for="" class="text text-primary">Publier:<sup
                                class='text text-danger fw-bold '>*</sup>:</label>
                        <input name="is_published" class="form-check-input p-2 border border-secondary" type="checkbox"
                            id="flexCheckChecked">
                    </div>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="" class="border border-secondary form-control" cols="30" rows="6">
                    </textarea>
